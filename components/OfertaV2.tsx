...
import UpsellBasicoPopup from "./UpsellBasicoPopup";
...
export default function OfertaV2() {
  ...
  return (
    <section className="section" id="oferta">
        ...
        <div className="oferta-box">
          ...
          <div className="oferta-cards-grid">
            ...
            <div className="oferta-card">
              ...
              <div className="oferta-parcel">à vista no Pix ou cartão</div>
              ...
              <button
                ...
                style={{ width: "100%", fontSize: "clamp(13px,2.5vw,16px)", padding: "15px 20px", border: "none", cursor: "pointer" }}
              >
                QUERO O KIT BÁSICO
              </button>
            ...
            <div className="oferta-card oferta-card--destaque">
              ...
              <div className="oferta-parcel">ou 3× de <strong>R$ 9,30</strong> sem juros</div>
      ...
      <UpsellBasicoPopup open={showUpsell} onClose={() => setShowUpsell(false)} />
    </section>
  );
}
